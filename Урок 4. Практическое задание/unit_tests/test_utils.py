...
"""
Для функций get_message и send_message нужна имитация сокета.
Имитируем сокет через класс - заглушку (TestSocket)
"""
...
class Tests(unittest.TestCase):
    ...
    # тестируем корректность работы фукции отправки,создадим тестовый сокет и проверим
    ...
    def test_send_message(self):
        ...
        # проверка корретности кодирования словаря. сравниваем результат довренного
        # кодирования и результат от тестируемой функции
