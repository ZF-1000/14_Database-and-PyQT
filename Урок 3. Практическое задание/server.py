...
class Server(threading.Thread, metaclass=ServerMaker):
    ...
    def init_socket(self):
        ...
        serv_sock.bind((self.addr, self.port))      # bind — привязывает сокет к IP-адресу и порту машины
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                client_sock, client_address = self.sock.accept()    # Принять запрос на соединение
            except OSError:
                pass
            else:
    ...
    def process_client_message(self, message, client):
        ...
        if ACTION in message and message[ACTION] == PRESENCE and TIME in message and USER in message:
            # Если такой пользователь ещё не зарегистрирован, регистрируем, иначе отправляем ответ и
...
def main():
    ...
    # Создание экземпляра класса - сервера и его запуска
